...
load Objective_Results.mat ;
load Estimated_Objective_Results.mat ;
...
% Tile 1
nexttile
plot(trainTbl.NormalizedRoughness,trainTbl.NormalizedRoughness,'Color',grayColor,'LineWidth',2);
hold on;
plot(trainTbl.NormalizedRoughness,predictedY2,"k.",'MarkerSize',12);
...
plot(trainTbl.NormalizedRoughness,trainTbl.NormalizedRoughness,'Color',grayColor,'LineWidth',2);
hold on;
plot(testTbl.NormalizedRoughness,predictedY,"k.",'MarkerSize',12);
...
plot(trainTbl.NormalizedRoughness,trainTbl.NormalizedRoughness,'Color',grayColor,'LineWidth',2);
hold on;
plot(input.NormalizedRoughness,predictedY1,"k.",'MarkerSize',12);

tic;
nvars = 3;
options = optimoptions('gamultiobj','ConstraintTolerance',1e-6,'PlotFcn',"gaplotpareto",'PopulationSize',500,'Generations',10,'CrossoverFraction',0.8,'MutationFcn',@mutationadaptfeasible,'ParetoFraction',0.35);
rng default;

...
row2 = {'Cutting' 'Cutting' 'Feed'};
row3 = {'Time' 'Speed' 'Rate'};
...
b = barh(y,0.5,'red');
%yticklabels({['Normalized',newline,'Feed \n Rate'],'Normalized \n Cutting \n Speed','Normalized \nCutting\n Time'})
%yticklabels(regexprep(convertCharsToStrings(X_train.Properties.VariableNames(sortedPredictorIndices)),'([A-Z])', ' $1'));
